    ...
    return (
        <div>
            ...
            <div className="cont">
                <div className="blogCont1">
                    <div className="blogInfo">
                        <h2><span style={style}>Blog Name:</span> Applying Basic Destructuring in React</h2>
                ...
                <div className="blogCont1">
                    <div className="blogInfo">
                        <h2><span style={style}>Blog Name:</span> A Brief. Intro to Color Theory</h2>
            ...
            <div className="cont">
                <div className="blogCont1">
                    <div className="blogInfo">
                        <h2><span style={style}>Blog Name:</span> The Basics of JSX in React.js</h2>

                        <h2>Link:
                                <a href="https://mcasimirian.medium.com/the-basics-of-using-jsx-in-react-js-578db41ec625"> Blog </a> </h2>
                        <img className="blogIG" alt="" src="https://miro.medium.com/max/960/1*jcyp66zO_oLOAZbTY4a-vQ.gif"></img>
                    </div>
                </div>
                <div className="blogCont1">
                    <div className="blogInfo">
                        <h2><span style={style}>Blog Name:</span> 5 Tips for Creatives Navigating a Coding Bootcamp</h2>
